...
<?php $h = get_field('header', get_option('page_on_front')); ?>
  ...
  <div class="container">
    <div class="header_wrapper">
      ...
      <div class="header__contacts">
        ...
        <?php endif; ?>
        <?php if (!empty($h['phone_1'])): ?>
          <p><?php echo esc_html($h['phone_1']); ?></p>
        <?php endif; ?>
        <?php if (!empty($h['phone_2'])): ?>
          <p><?php echo esc_html($h['phone_2']); ?></p>
        <?php endif; ?>
      </div>
